...
export default async function InterviewPrepPage() {
  ...
  try {
    ...
    // fallback -> prevents crash on Vercel if DB/API fails
    assessments = [];
  }
  ...
  return (
    <div className="px-4">
      {/* Hero Section */}
      <div className="flex flex-col items-center justify-center text-center mb-16 mt-16">
        ...
        <p className="mt-6 text-base sm:text-lg md:text-xl lg:text-2xl text-gray-300 max-w-3xl">
          Master your skills with structured practice, real-world assessments,
          and expert tips.
        </p>
      </div>
      ...
      <div className="space-y-6">
        {/* Ensure child components are marked with "use client" */}
